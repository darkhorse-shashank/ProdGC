...
/**
 * @generated
 *  Flow: RetrieveGCMediationCmpt Interface: RetrieveAccessGC Operation: findSubReceiptDetails Type: response Custom Mediation: Total Amount Calculation
 */
public class Custom1579499756139 extends ESBMediationPrimitive {
		...
		*/
		...
		try {
			...
			String receiptDate = smo
					.getString("/body/fetchSubReceiptDetailsResponse/FetchSubReceiptDetailsResult/receiptDate");
			String instrumentDate = smo
					.getString("/body/fetchSubReceiptDetailsResponse/FetchSubReceiptDetailsResult/instrumentDate");
			if (receiptDate != null && receiptDate != "") {
				...
				smo.setString("/body/fetchSubReceiptDetailsResponse/FetchSubReceiptDetailsResult/receiptDate",
						formattedDate);
			} else {
			...
			if (instrumentDate != null && instrumentDate != "") {
				...
				formattedDate = targetFormat.format(originalDate);
				smo.setString("/body/fetchSubReceiptDetailsResponse/FetchSubReceiptDetailsResult/instrumentDate",
						formattedDate);
			} else {
			...
			String crsAmount = smo.getString(
					"/body/fetchSubReceiptDetailsResponse/FetchSubReceiptDetailsResult/SubRecieptDtls[1]/instrument_amt");
			String balance = smo.getString(
					"/body/fetchSubReceiptDetailsResponse/FetchSubReceiptDetailsResult/SubRecieptDtls[1]/balance_amt");
