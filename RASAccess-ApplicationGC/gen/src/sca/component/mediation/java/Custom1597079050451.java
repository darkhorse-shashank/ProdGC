...
/**
 * @generated
 *  Flow: MaintainGCMediationCmpt Interface: MaintainAccessGC Operation: createExcessRefund Type: response Custom Mediation: saveFailedResponseStructure
 */
public class Custom1597079050451 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		if (smo.getString("/body/createExcessRefundFault1_createExcessRefundFault/error[0]/errorCode") != null
				&& !"".equalsIgnoreCase(
						smo.getString("/body/createExcessRefundFault1_createExcessRefundFault/error[0]/errorCode")))
			smo.setString("/context/correlation/errorCode",
					smo.getString("/body/createExcessRefundFault1_createExcessRefundFault/error[0]/errorCode"));
		else
			smo.setString("/context/correlation/errorCode", "");
		if (smo.getString("/body/createExcessRefundFault1_createExcessRefundFault/error[0]/errorDetail") != null
				&& !"".equalsIgnoreCase(
						smo.getString("/body/createExcessRefundFault1_createExcessRefundFault/error[0]/errorDetail")))
