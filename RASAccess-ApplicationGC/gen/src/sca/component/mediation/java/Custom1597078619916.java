...
/**
 * @generated
 *  Flow: MaintainGCMediationCmpt Interface: MaintainAccessGC Operation: createExcessRefund Type: request Custom Mediation: AssignTransactionId
 */
public class Custom1597078619916 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		System.out.println("Callout error handler Excess refund request");
		try {
			smo.setInt("/context/correlation/transactionId", smo.getInt("/body/createExcessRefund/transactionId"));
