...
/**
 * @generated
 *  Flow: RetrieveGCMediationCmpt Interface: RetrieveAccessGC Operation: findPolicyStatus Type: response Custom Mediation: SaveFailedResponseStructure
 */
public class Custom1599049929949 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		if (smo.getString("/body/findPolicyStatusFault1_findPolicyStatusFault/error[0]/errorCode") != null
				&& !"".equalsIgnoreCase(
						smo.getString("/body/findPolicyStatusFault1_findPolicyStatusFault/error[0]/errorCode")))
			smo.setString("/context/correlation/errorCode",
					smo.getString("/body/findPolicyStatusFault1_findPolicyStatusFault/error[0]/errorCode"));
		else
			smo.setString("/context/correlation/errorCode", "");
		if (smo.getString("/body/findPolicyStatusFault1_findPolicyStatusFault/error[0]/errorDetail") != null
				&& !"".equalsIgnoreCase(
						smo.getString("/body/findPolicyStatusFault1_findPolicyStatusFault/error[0]/errorDetail")))
