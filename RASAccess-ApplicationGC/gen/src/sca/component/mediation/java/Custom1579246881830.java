...
/**
 * @generated
 *  Flow: RetrieveGCMediationCmpt Interface: RetrieveAccessGC Operation: findProposals Type: response Custom Mediation: FormatDates
 */
public class Custom1579246881830 extends ESBMediationPrimitive {
		...
		*/
		try {
			int size = smo.getList(
					"/body/proposalDetailsResponse/ProposalDetailsResponse/ProposalDetailsResult/ProposalDetails/objProposalDetails/Proposal")
					.size();
			...
			for (int i = 1; i <= size; i++) {
				...
				String date = smo.getString(
						"/body/proposalDetailsResponse/ProposalDetailsResponse/ProposalDetailsResult/ProposalDetails/objProposalDetails/Proposal["
								+ i + "]/ProposalDate");
				String proposalNo = smo.getString(
						"/body/proposalDetailsResponse/ProposalDetailsResponse/ProposalDetailsResult/ProposalDetails/objProposalDetails/Proposal["
								+ i + "]/ProposalNo");
