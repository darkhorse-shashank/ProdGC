...
/**
 * @generated
 *  Flow: RetrieveGCMediationCmpt Interface: RetrieveAccessGC Operation: calculateCancellationRefund Type: response Custom Mediation: saveFailedResponseStructure
 */
public class Custom1596082196359 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		if (smo.getString(
				"/body/calculateCancellationRefundFault1_calculateCancellationRefundFault/error[0]/errorCode") != null
				&& !"".equalsIgnoreCase(smo.getString(
						"/body/calculateCancellationRefundFault1_calculateCancellationRefundFault/error[0]/errorCode")))
			smo.setString("/context/correlation/errorCode", smo.getString(
					"/body/calculateCancellationRefundFault1_calculateCancellationRefundFault/error[0]/errorCode"));
		else
			smo.setString("/context/correlation/errorCode", "");

		if (smo.getString(
				"/body/calculateCancellationRefundFault1_calculateCancellationRefundFault/error[0]/errorDetail") != null
				&& !"".equalsIgnoreCase(smo.getString(
						"/body/calculateCancellationRefundFault1_calculateCancellationRefundFault/error[0]/errorDetail")))
			smo.setString("/context/correlation/errorDetail", smo.getString(
					"/body/calculateCancellationRefundFault1_calculateCancellationRefundFault/error[0]/errorDetail"));
		else
