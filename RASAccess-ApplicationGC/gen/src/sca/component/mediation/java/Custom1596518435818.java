...
/**
 * @generated
 *  Flow: MaintainGCMediationCmpt Interface: MaintainAccessGC Operation: cancelPolicy Type: response Custom Mediation: saveFailedResponseStructure
 */
public class Custom1596518435818 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		if (smo.getString("/body/cancelPolicyFault1_cancelPolicyFault/error[0]/errorCode") != null
				&& !"".equalsIgnoreCase(smo.getString("/body/cancelPolicyFault1_cancelPolicyFault/error[0]/errorCode")))
			smo.setString("/context/correlation/errorCode",
					smo.getString("/body/cancelPolicyFault1_cancelPolicyFault/error[0]/errorCode"));
		else
			smo.setString("/context/correlation/errorCode", "");
		if (smo.getString("/body/cancelPolicyFault1_cancelPolicyFault/error[0]/errorDetail") != null && !""
				.equalsIgnoreCase(smo.getString("/body/cancelPolicyFault1_cancelPolicyFault/error[0]/errorDetail")))
			smo.setString("/context/correlation/errorDetail",
					smo.getString("/body/cancelPolicyFault1_cancelPolicyFault/error[0]/errorDetail"));
		else
			smo.setString("/context/correlation/errorDetail", "");
