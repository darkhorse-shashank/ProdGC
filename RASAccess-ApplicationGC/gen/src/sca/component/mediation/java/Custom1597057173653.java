...
/**
 * @generated
 *  Flow: RetrieveGCMediationCmpt Interface: RetrieveAccessGC Operation: findRefundStatus Type: response Custom Mediation: SaveFailedResponseStructure
 */
public class Custom1597057173653 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		if (smo.getString("/body/findRefundStatusFault1_findRefundStatusFault/error[0]/errorCode") != null
				&& !"".equalsIgnoreCase(
						smo.getString("/body/findRefundStatusFault1_findRefundStatusFault/error[0]/errorCode")))
			smo.setString("/context/correlation/errorCode",
					smo.getString("/body/findRefundStatusFault1_findRefundStatusFault/error[0]/errorCode"));
		else
			smo.setString("/context/correlation/errorCode", "");
		if (smo.getString("/body/findRefundStatusFault1_findRefundStatusFault/error[0]/errorDetail") != null
				&& !"".equalsIgnoreCase(
						smo.getString("/body/findRefundStatusFault1_findRefundStatusFault/error[0]/errorDetail")))
