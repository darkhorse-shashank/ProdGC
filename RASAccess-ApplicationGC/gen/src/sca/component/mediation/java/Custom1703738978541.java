...
/**
 * @generated
 *  Flow: MaintainGCMediationCmpt Interface: MaintainAccessGC Operation: cancelPolicy Type: request Custom Mediation: Check Certificate Number
 */
public class Custom1703738978541 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		System.out.println(
				"Certificate Number --> " + smo.getString("/body/cancelPolicy/cancPolicyData/certificateNumber"));
		System.out.println("".equalsIgnoreCase(smo.getString("/body/cancelPolicy/cancPolicyData/certificateNumber"))
				|| smo.getString("/body/cancelPolicy/cancPolicyData/certificateNumber") == null);
		if ("".equalsIgnoreCase(smo.getString("/body/cancelPolicy/cancPolicyData/certificateNumber"))
				|| smo.getString("/body/cancelPolicy/cancPolicyData/certificateNumber") == null) {
			smo.setString("/body/cancelPolicy/cancPolicyData/certificateNumber", "");
		}
