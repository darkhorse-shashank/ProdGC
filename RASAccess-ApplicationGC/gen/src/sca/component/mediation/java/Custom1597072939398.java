...
/**
 * @generated
 *  Flow: MaintainGCMediationCmpt Interface: MaintainAccessGC Operation: createCancellationRefund Type: response Custom Mediation: SaveFailedResponseStructure
 */
public class Custom1597072939398 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		*/
		...
		if (smo.getString(
				"/body/createCancellationRefundFault1_createCancellationRefundFault/error[0]/errorCode") != null
				&& !"".equalsIgnoreCase(smo.getString(
						"/body/createCancellationRefundFault1_createCancellationRefundFault/error[0]/errorCode")))
			smo.setString("/context/correlation/errorCode", smo.getString(
					"/body/createCancellationRefundFault1_createCancellationRefundFault/error[0]/errorCode"));
		else
			smo.setString("/context/correlation/errorCode", "");
		if (smo.getString(
				"/body/createCancellationRefundFault1_createCancellationRefundFault/error[0]/errorDetail") != null
				&& !"".equalsIgnoreCase(smo.getString(
						"/body/createCancellationRefundFault1_createCancellationRefundFault/error[0]/errorDetail")))
