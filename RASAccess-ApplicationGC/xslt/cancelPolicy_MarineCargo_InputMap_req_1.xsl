...
<!-- @generated mapFile="xslt/cancelPolicy_MarineCargo_InputMap_req_1.map" md5sum="361f4f3439bc0e7572c124644cf558a9" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_MarineCargo_InputMap_req_1.map
*   Map declaration(s):	cancelPolicy_MarineCargo_InputMap_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fstub.tagicesb.com%252Fwsdl%252FRASMarineService%252F%257DwebServiceRefundCancellationMarine/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_MarineCargo_InputMap_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_MarineCargo_InputMap_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicy_MarineCargo_InputMap_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:cancelPolicy_MarineCargo_InputMap_req_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out3:webServiceRefundCancellationMarine'"/>
        </xsl:attribute>
        <out2:webServiceRefundCancellationMarine>
          ...
          <!-- a simple data mapping: "body/in3:cancelPolicy/cancellationRefundInput/campaign"(string) to "out2:campaign"(string) -->
          ...
          <out2:RefundCancellation>
            ...
            <!-- a simple data mapping: "body/in3:cancelPolicy/cancPolicyData/refundAmount"(string) to "out:RefundAmount"(string) -->
  ...
  <xsl:template name="map:cancelPolicy_MarineCargo_InputMap_req_12">
    <xsl:param name="smo"/>
    <context>
    ...
    <body>
      ...
      <out2:webServiceRefundCancellationMarine>
        ...
        <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancellationRefundInput/campaign"(string) to "out2:campaign"(string) -->
        ...
        <out2:RefundCancellation>
          ...
          <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancPolicyData/refundAmount"(string) to "out:RefundAmount"(string) -->
