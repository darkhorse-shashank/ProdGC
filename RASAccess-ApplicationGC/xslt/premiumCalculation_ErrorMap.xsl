...
<!-- @generated mapFile="xslt/premiumCalculation_ErrorMap.map" md5sum="cc3d69f67612bd9ff6f4c5065c277185" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		premiumCalculation_ErrorMap.map
*   Map declaration(s):	premiumCalculation_ErrorMap
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/premiumCalculation_ErrorMap"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:premiumCalculation_ErrorMap2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:premiumCalculation_ErrorMap"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:premiumCalculation_ErrorMap">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out4:calculateCancellationRefundFault1_calculateCancellationRefundFault>
          ...
          <out:error>
            <!-- a simple mapping with no associated source:  to "out:errorCode"(string) -->
            ...
            <!-- a simple data mapping: "context/failInfo/origin"(string) to "out:errorDetail"(string) -->
  ...
  <xsl:template name="map:premiumCalculation_ErrorMap2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out2:calculateCancellationRefund_calculateCancellationRefundFaultMsg'"/>
      ...
      <out4:calculateCancellationRefundFault1_calculateCancellationRefundFault>
        ...
        <out:error>
          ...
          <!-- a simple data mapping: "$smo/context/failInfo/origin"(string) to "out:errorDetail"(string) -->
