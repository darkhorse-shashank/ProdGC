...
<!-- @generated mapFile="xslt/TenureDetailsExceptionMap.map" md5sum="5813789cec4ac3e4a37d4d71ff5cceb0" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		TenureDetailsExceptionMap.map
*   Map declaration(s):	TenureDetailsExceptionMap
*   Input file(s):		smo://smo/name%3Dwsdl-primary/xpath%3D%252F/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DtenureDetails_tenureDetailsFaultMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/TenureDetailsExceptionMap"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:TenureDetailsExceptionMap2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io6:smo" mode="map:TenureDetailsExceptionMap">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io6:smo"  mode="map:TenureDetailsExceptionMap">
    <io6:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:TenureDetailsExceptionMap2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out5:tenureDetails_tenureDetailsFaultMsg'"/>
