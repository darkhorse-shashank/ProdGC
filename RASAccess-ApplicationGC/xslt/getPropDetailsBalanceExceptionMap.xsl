...
<!-- @generated mapFile="xslt/getPropDetailsBalanceExceptionMap.map" md5sum="a9ab23c3e6e9dc4bcfab261537c5b339" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		getPropDetailsBalanceExceptionMap.map
*   Map declaration(s):	getPropDetailsBalanceExceptionMap
*   Input file(s):		smo://smo/name%3Dwsdl-primary/xpath%3D%252F/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DgetProposalDetailsBalanceRefund_getProposalDetailsBalanceRefundFaultMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/getPropDetailsBalanceExceptionMap"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:getPropDetailsBalanceExceptionMap2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io6:smo" mode="map:getPropDetailsBalanceExceptionMap">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io6:smo"  mode="map:getPropDetailsBalanceExceptionMap">
    <io6:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:getPropDetailsBalanceExceptionMap2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out5:getProposalDetailsBalanceRefund_getProposalDetailsBalanceRefundFaultMsg'"/>
