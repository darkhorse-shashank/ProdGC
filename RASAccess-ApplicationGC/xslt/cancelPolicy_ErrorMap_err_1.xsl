...
<!-- @generated mapFile="xslt/cancelPolicy_ErrorMap_err_1.map" md5sum="146afb6d40c056875f05838cf0aa1fad" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_ErrorMap_err_1.map
*   Map declaration(s):	cancelPolicy_ErrorMap_err_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_ErrorMap_err_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_ErrorMap_err_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:cancelPolicy_ErrorMap_err_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:cancelPolicy_ErrorMap_err_1">
    <io3:smo>
      <context>
  ...
  <xsl:template name="map:cancelPolicy_ErrorMap_err_12">
    <xsl:param name="smo"/>
    <context>
