...
<!-- @generated mapFile="xslt/find_PolicyStatus_OutputMap_res_1.map" md5sum="39cd55ef70d169b254b51a43c6d661d4" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		find_PolicyStatus_OutputMap_res_1.map
*   Map declaration(s):	find_PolicyStatus_OutputMap_res_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DfindPolicyStatusResponseMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/find_PolicyStatus_OutputMap_res_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:find_PolicyStatus_OutputMap_res_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:find_PolicyStatus_OutputMap_res_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:find_PolicyStatus_OutputMap_res_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out5:findPolicyStatusResponseMsg'"/>
        </xsl:attribute>
        <out3:findPolicyStatusResponse>
          <response>
            <!-- a simple data mapping: "body/in2:getProposalStatusResponse/in2:GetProposalStatusResult/Status"(string) to "out4:status"(string) -->
            ...
            <!-- a simple data mapping: "body/in2:getProposalStatusResponse/in2:GetProposalStatusResult/PolicyNo"(string) to "out4:data"(string) -->
  ...
  <xsl:template name="map:find_PolicyStatus_OutputMap_res_12">
    <xsl:param name="smo"/>
    <context>
    ...
    <body>
      ...
      <out3:findPolicyStatusResponse>
        <response>
          <!-- a simple data mapping: "$smo/body/in2:getProposalStatusResponse/in2:GetProposalStatusResult/Status"(string) to "out4:status"(string) -->
          ...
          <!-- a simple data mapping: "$smo/body/in2:getProposalStatusResponse/in2:GetProposalStatusResult/PolicyNo"(string) to "out4:data"(string) -->
