...
<!-- @generated mapFile="xslt/calculatePremium_ErrorMap_err_1.map" md5sum="2b7b616051e9dd119a398c8e56860790" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		calculatePremium_ErrorMap_err_1.map
*   Map declaration(s):	calculatePremium_ErrorMap_err_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/calculatePremium_ErrorMap_err_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:calculatePremium_ErrorMap_err_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:calculatePremium_ErrorMap_err_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:calculatePremium_ErrorMap_err_1">
    <io2:smo>
      <context>
  ...
  <xsl:template name="map:calculatePremium_ErrorMap_err_12">
    <xsl:param name="smo"/>
    <context>
