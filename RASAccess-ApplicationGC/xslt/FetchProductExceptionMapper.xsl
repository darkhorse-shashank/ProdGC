...
<!-- @generated mapFile="xslt/FetchProductExceptionMapper.map" md5sum="6dba1a6dcb9431943437149a4b6db167" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		FetchProductExceptionMapper.map
*   Map declaration(s):	FetchProductExceptionMapper
*   Input file(s):		smo://smo/name%3Dwsdl-primary/xpath%3D%252F/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DfetchProductDetails_fetchProductDetailsFaultMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/FetchProductExceptionMapper"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:FetchProductExceptionMapper2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io6:smo" mode="map:FetchProductExceptionMapper">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io6:smo"  mode="map:FetchProductExceptionMapper">
    <io6:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:FetchProductExceptionMapper2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out5:fetchProductDetails_fetchProductDetailsFaultMsg'"/>
