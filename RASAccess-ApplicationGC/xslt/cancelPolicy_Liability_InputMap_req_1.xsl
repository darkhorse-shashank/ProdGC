...
<!-- @generated mapFile="xslt/cancelPolicy_Liability_InputMap_req_1.map" md5sum="556cde3981b20fd7163d3f083d8f75a1" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_Liability_InputMap_req_1.map
*   Map declaration(s):	cancelPolicy_Liability_InputMap_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fstub.tagicesb.com%252Fwsdl%252FRASCasualty%252F%257DwebServiceRefundCancellationCasualty/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_Liability_InputMap_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_Liability_InputMap_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicy_Liability_InputMap_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:cancelPolicy_Liability_InputMap_req_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:webServiceRefundCancellationCasualty'"/>
        </xsl:attribute>
        <out3:webServiceRefundCancellationCasualty>
          ...
          <out3:RefundCancellation>
            ...
            <!-- a simple data mapping: "body/in3:cancelPolicy/cancPolicyData/retainMinPrem"(string) to "out2:RetainMinPrem"(string) -->
            ...
            <!-- a simple data mapping: "body/in3:cancelPolicy/cancPolicyData/erfPrem"(string) to "out2:ERFPrem"(string) -->
            <xsl:if test="body/in3:cancelPolicy/cancPolicyData/erfPrem">
              <xsl:element name="out2:ERFPrem">
                <xsl:value-of select="body/in3:cancelPolicy/cancPolicyData/erfPrem"/>
              </xsl:element>
            </xsl:if>
            <!-- a simple data mapping: "body/in3:cancelPolicy/cancPolicyData/endtPrem"(string) to "out2:EndtPrem"(string) -->
            <xsl:if test="body/in3:cancelPolicy/cancPolicyData/endtPrem">
              <xsl:element name="out2:EndtPrem">
                <xsl:value-of select="body/in3:cancelPolicy/cancPolicyData/endtPrem"/>
              </xsl:element>
            </xsl:if>
  ...
  <xsl:template name="map:cancelPolicy_Liability_InputMap_req_12">
    <xsl:param name="smo"/>
    <context>
    ...
    <body>
      ...
      <out3:webServiceRefundCancellationCasualty>
        ...
        <out3:RefundCancellation>
          ...
          <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancPolicyData/retainMinPrem"(string) to "out2:RetainMinPrem"(string) -->
          ...
          <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancPolicyData/erfPrem"(string) to "out2:ERFPrem"(string) -->
          <xsl:if test="$smo/body/in3:cancelPolicy/cancPolicyData/erfPrem">
            <xsl:element name="out2:ERFPrem">
              <xsl:value-of select="$smo/body/in3:cancelPolicy/cancPolicyData/erfPrem"/>
            </xsl:element>
          </xsl:if>
          <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancPolicyData/endtPrem"(string) to "out2:EndtPrem"(string) -->
          <xsl:if test="$smo/body/in3:cancelPolicy/cancPolicyData/endtPrem">
            <xsl:element name="out2:EndtPrem">
              <xsl:value-of select="$smo/body/in3:cancelPolicy/cancPolicyData/endtPrem"/>
            </xsl:element>
          </xsl:if>
