...
<!-- @generated mapFile="xslt/cancelPolicyHealthInput.map" md5sum="541c8eca064228a7185d7d05fb2b13e0" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		cancelPolicyHealthInput.map
*   Map declaration(s):	cancelPolicyHealthInput
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257BWebService_RefundCancellationHealth%257DWebService_RefundCancellationHealthSoapIn/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:out2="WebService_RefundCancellationHealth"
    xmlns:out="wsdl.WebService_RefundCancellationHealth"
    xmlns:in5="http://GCLibrary/org/aig/access/bo"
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicyHealthInput"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicyHealthInput2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicyHealthInput"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:cancelPolicyHealthInput">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:WebService_RefundCancellationHealthSoapIn'"/>
        </xsl:attribute>
        <out2:WebService_RefundCancellationHealth>
  ...
  <xsl:template name="map:cancelPolicyHealthInput2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out:WebService_RefundCancellationHealthSoapIn'"/>
