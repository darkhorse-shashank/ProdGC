...
<!-- @generated mapFile="xslt/cancelPolicy_PropertyandEnergy_InputMap_req_1.map" md5sum="27512571ee4c904ece5c0a0fbda2e57f" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_PropertyandEnergy_InputMap_req_1.map
*   Map declaration(s):	cancelPolicy_PropertyandEnergy_InputMap_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fstub.unotechsoft.com%252Fwsdl%252FRASPropertyEnergyService%252F%257DwebServiceRefundCancellationPE/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_PropertyandEnergy_InputMap_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_PropertyandEnergy_InputMap_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicy_PropertyandEnergy_InputMap_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:cancelPolicy_PropertyandEnergy_InputMap_req_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:webServiceRefundCancellationPE'"/>
        </xsl:attribute>
        <out2:webServiceRefundCancellationPE>
  ...
  <xsl:template name="map:cancelPolicy_PropertyandEnergy_InputMap_req_12">
    <xsl:param name="smo"/>
    <context>
