...
<!-- @generated mapFile="xslt/PolicyEndoExceptionMap.map" md5sum="05ff56f84f648f5613e0754d2aba2d07" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		PolicyEndoExceptionMap.map
*   Map declaration(s):	PolicyEndoExceptionMap
*   Input file(s):		smo://smo/name%3Dwsdl-primary/xpath%3D%252F/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DfindPropEndoData_findPropEndoDataFaultMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/PolicyEndoExceptionMap"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:PolicyEndoExceptionMap2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io6:smo" mode="map:PolicyEndoExceptionMap">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io6:smo"  mode="map:PolicyEndoExceptionMap">
    <io6:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:PolicyEndoExceptionMap2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out5:findPropEndoData_findPropEndoDataFaultMsg'"/>
