...
<!-- @generated mapFile="xslt/findPolicyStatus_ErrorMap.map" md5sum="3bccd698f0388d5f2efcc6fc63d88f6c" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		findPolicyStatus_ErrorMap.map
*   Map declaration(s):	findPolicyStatus_ErrorMap
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/findPolicyStatus_ErrorMap"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:findPolicyStatus_ErrorMap2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:findPolicyStatus_ErrorMap"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:findPolicyStatus_ErrorMap">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out2:findPolicyStatus_findPolicyStatusFaultMsg'"/>
        </xsl:attribute>
        <out4:findPolicyStatusFault1_findPolicyStatusFault>
          ...
          <out:error>
            <!-- a simple data mapping: "context/failInfo/origin"(string) to "out:errorCode"(string) -->
            ...
            <xsl:element name="out:message">
              <xsl:text>Find Policy Detail Failed</xsl:text>
            </xsl:element>
            <!-- a simple data mapping: "context/failInfo/failureString"(string) to "out:errorDetail"(string) -->
  ...
  <xsl:template name="map:findPolicyStatus_ErrorMap2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out2:findPolicyStatus_findPolicyStatusFaultMsg'"/>
      ...
      <out4:findPolicyStatusFault1_findPolicyStatusFault>
        ...
        <out:error>
          <!-- a simple data mapping: "$smo/context/failInfo/origin"(string) to "out:errorCode"(string) -->
          ...
          <!-- a simple data mapping: "$smo/context/failInfo/failureString"(string) to "out:errorDetail"(string) -->
