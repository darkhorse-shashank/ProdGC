...
<!-- @generated mapFile="xslt/cancelPolicy_TradeCredit_InputMap_req_1.map" md5sum="ae24e9d866c70c411f38bfdaa29acce2" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_TradeCredit_InputMap_req_1.map
*   Map declaration(s):	cancelPolicy_TradeCredit_InputMap_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fcom.tagic.esb.RASTradeCreditStub%252Fwsdl%252FRASTradeCreditService%252F%257DwebServiceRefundCancellationTradeCredit/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_TradeCredit_InputMap_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_TradeCredit_InputMap_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicy_TradeCredit_InputMap_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:cancelPolicy_TradeCredit_InputMap_req_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out3:webServiceRefundCancellationTradeCredit'"/>
        </xsl:attribute>
        <out:webServiceRefundCancellationTradeCredit>
          ...
          <out:RefundCancellation>
            ...
            <!-- a simple data mapping: "context/correlation/endDateOfRequest"(string) to "out2:CancellationDate"(string) -->
            ...
            <!-- a simple data mapping: "body/in3:cancelPolicy/cancPolicyData/retainMinPrem"(string) to "out2:RefundAmt"(string) -->
  ...
  <xsl:template name="map:cancelPolicy_TradeCredit_InputMap_req_12">
    <xsl:param name="smo"/>
    <context>
    ...
    <body>
      ...
      <out:webServiceRefundCancellationTradeCredit>
        ...
        <out:RefundCancellation>
          ...
          <!-- a simple data mapping: "$smo/context/correlation/endDateOfRequest"(string) to "out2:CancellationDate"(string) -->
          ...
          <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancPolicyData/retainMinPrem"(string) to "out2:RefundAmt"(string) -->
