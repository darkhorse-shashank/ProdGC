...
<!-- @generated mapFile="xslt/cancelPolicyTravelRequest.map" md5sum="444d10a56c1129e9f36372204a59baa9" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		cancelPolicyTravelRequest.map
*   Map declaration(s):	cancelPolicyTravelRequest
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257BWebService_RefundCancellationLTA%257DWebService_RefundCancellationLTASoapIn/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:out2="WebService_RefundCancellationLTA"
    xmlns:out="wsdl.WebService_RefundCancellationLTA"
    xmlns:in5="http://GCLibrary/org/aig/access/bo"
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicyTravelRequest"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicyTravelRequest2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicyTravelRequest"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:cancelPolicyTravelRequest">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:WebService_RefundCancellationLTASoapIn'"/>
        </xsl:attribute>
        <out2:WebService_RefundCancellationLTA>
  ...
  <xsl:template name="map:cancelPolicyTravelRequest2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out:WebService_RefundCancellationLTASoapIn'"/>
