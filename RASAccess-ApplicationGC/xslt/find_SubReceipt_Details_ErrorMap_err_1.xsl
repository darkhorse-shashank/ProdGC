...
<!-- @generated mapFile="xslt/find_SubReceipt_Details_ErrorMap_err_1.map" md5sum="56ffde8fee11a66b40ecebb4573ee430" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		find_SubReceipt_Details_ErrorMap_err_1.map
*   Map declaration(s):	find_SubReceipt_Details_ErrorMap_err_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/find_SubReceipt_Details_ErrorMap_err_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:find_SubReceipt_Details_ErrorMap_err_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:find_SubReceipt_Details_ErrorMap_err_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:find_SubReceipt_Details_ErrorMap_err_1">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out5:findSubReceiptDetails_fetchSubReceiptDetailsFaultMsg'"/>
        </xsl:attribute>
        <out3:fetchSubReceiptDetailsFault1_fetchSubReceiptDetailsFault>
  ...
  <xsl:template name="map:find_SubReceipt_Details_ErrorMap_err_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out5:findSubReceiptDetails_fetchSubReceiptDetailsFaultMsg'"/>
