...
<!-- @generated mapFile="xslt/CalloutErrorHandlerCancellationRefundRequest.map" md5sum="b722191457539effca5a4d7d24020de1" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		CalloutErrorHandlerCancellationRefundRequest.map
*   Map declaration(s):	CalloutErrorHandlerCancellationRefundRequest
*   Input file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fstub.tagicesb.com%252Fwsdl%252FRASGenericService%252F%257DrefundRequest/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/CalloutErrorHandlerCancellationRefundRequest"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:CalloutErrorHandlerCancellationRefundRequest2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:CalloutErrorHandlerCancellationRefundRequest">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io3:smo"  mode="map:CalloutErrorHandlerCancellationRefundRequest">
    <io3:smo>
      <context>
  ...
  <xsl:template name="map:CalloutErrorHandlerCancellationRefundRequest2">
    <xsl:param name="smo"/>
    <context>
