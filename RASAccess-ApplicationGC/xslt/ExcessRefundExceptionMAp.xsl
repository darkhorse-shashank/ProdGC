...
<!-- @generated mapFile="xslt/ExcessRefundExceptionMAp.map" md5sum="b3c0522b8f4ad50efc87ed8858f35258" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		ExcessRefundExceptionMAp.map
*   Map declaration(s):	ExcessRefundExceptionMAp
*   Input file(s):		smo://smo/name%3Dwsdl-primary/xpath%3D%252F/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DexcessRefundEMIDetails_excessRefundEMIDetailsFaultMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/ExcessRefundExceptionMAp"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:ExcessRefundExceptionMAp2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io6:smo" mode="map:ExcessRefundExceptionMAp">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io6:smo"  mode="map:ExcessRefundExceptionMAp">
    <io6:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:ExcessRefundExceptionMAp2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out5:excessRefundEMIDetails_excessRefundEMIDetailsFaultMsg'"/>
