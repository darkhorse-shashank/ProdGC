...
<!-- @generated mapFile="xslt/update_Disbursement_ErrorMap_err_1.map" md5sum="678c77ae5cd3c857905a0a0a5b58ddec" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		update_Disbursement_ErrorMap_err_1.map
*   Map declaration(s):	update_Disbursement_ErrorMap_err_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/update_Disbursement_ErrorMap_err_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:update_Disbursement_ErrorMap_err_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:update_Disbursement_ErrorMap_err_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:update_Disbursement_ErrorMap_err_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:update_Disbursement_ErrorMap_err_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out4:updateDisbursement_updateDisbursementFaultMsg'"/>
