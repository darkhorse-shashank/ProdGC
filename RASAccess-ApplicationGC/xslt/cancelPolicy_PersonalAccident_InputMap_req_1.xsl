...
<!-- @generated mapFile="xslt/cancelPolicy_PersonalAccident_InputMap_req_1.map" md5sum="979ee3845378bf7cecc5f69cc86ef1a9" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_PersonalAccident_InputMap_req_1.map
*   Map declaration(s):	cancelPolicy_PersonalAccident_InputMap_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fstub.tagicesb.com%252Fwsdl%252FRASPAService%252F%257DwebServiceRefundCancellationPA/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_PersonalAccident_InputMap_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_PersonalAccident_InputMap_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicy_PersonalAccident_InputMap_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:cancelPolicy_PersonalAccident_InputMap_req_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out2:webServiceRefundCancellationPA'"/>
        </xsl:attribute>
        <out:webServiceRefundCancellationPA>
  ...
  <xsl:template name="map:cancelPolicy_PersonalAccident_InputMap_req_12">
    <xsl:param name="smo"/>
    <context>
