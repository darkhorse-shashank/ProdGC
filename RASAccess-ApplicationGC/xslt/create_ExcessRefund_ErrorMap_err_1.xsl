...
<!-- @generated mapFile="xslt/create_ExcessRefund_ErrorMap_err_1.map" md5sum="b22463a241ff93d4811f08ce08fb7f09" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		create_ExcessRefund_ErrorMap_err_1.map
*   Map declaration(s):	create_ExcessRefund_ErrorMap_err_1
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/create_ExcessRefund_ErrorMap_err_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:create_ExcessRefund_ErrorMap_err_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:create_ExcessRefund_ErrorMap_err_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:create_ExcessRefund_ErrorMap_err_1">
    <io3:smo>
      <context>
      ...
      <body>
        ...
        <out3:createExcessRefundFault1_createExcessRefundFault>
          ...
          <out5:error>
            <!-- a simple data mapping: "context/failInfo/origin"(string) to "out5:errorCode"(string) -->
            ...
            <!-- a simple data mapping: "context/failInfo/failureString"(string) to "out5:errorDetail"(string) -->
  ...
  <xsl:template name="map:create_ExcessRefund_ErrorMap_err_12">
    <xsl:param name="smo"/>
    <context>
    ...
    <body>
      ...
      <out3:createExcessRefundFault1_createExcessRefundFault>
        ...
        <out5:error>
          <!-- a simple data mapping: "$smo/context/failInfo/origin"(string) to "out5:errorCode"(string) -->
          ...
          <!-- a simple data mapping: "$smo/context/failInfo/failureString"(string) to "out5:errorDetail"(string) -->
