...
<!-- @generated mapFile="xslt/CDDetailsExceptionMap.map" md5sum="9039e75ef53cc2df687ee52300b2e29e" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		CDDetailsExceptionMap.map
*   Map declaration(s):	CDDetailsExceptionMap
*   Input file(s):		smo://smo/name%3Dwsdl-primary/xpath%3D%252F/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FGCDomain-v1.0.0%252Forg%252Ftataaig%252Faccess%252FRetrieveAccessGC%257DfindCDDetails_findCDDetailsFaultMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://RASAccess-ApplicationGC/xslt/CDDetailsExceptionMap"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:CDDetailsExceptionMap2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:CDDetailsExceptionMap">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:CDDetailsExceptionMap">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:CDDetailsExceptionMap2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out3:findCDDetails_findCDDetailsFaultMsg'"/>
