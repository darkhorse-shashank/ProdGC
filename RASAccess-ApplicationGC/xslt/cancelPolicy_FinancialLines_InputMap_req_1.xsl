...
<!-- @generated mapFile="xslt/cancelPolicy_FinancialLines_InputMap_req_1.map" md5sum="b34ebf56df1c7e7a21e03fdd018e4707" version="8.0.501" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM Graphical Data Mapping Editor.
*   Version 8.0.5.0
*
*   Mapping file:		cancelPolicy_FinancialLines_InputMap_req_1.map
*   Map declaration(s):	cancelPolicy_FinancialLines_InputMap_req_1
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257Bhttp%253A%252F%252Fstub.unotechsoft.com%252Fwsdl%252FRASFinancialLines%252F%257DwebServiceRefundCancellationFinancialLines/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicy_FinancialLines_InputMap_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicy_FinancialLines_InputMap_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicy_FinancialLines_InputMap_req_1">
        </xsl:apply-templates>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="io2:smo"  mode="map:cancelPolicy_FinancialLines_InputMap_req_1">
    <io2:smo>
      <context>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:webServiceRefundCancellationFinancialLines'"/>
        </xsl:attribute>
        <out3:webServiceRefundCancellationFinancialLines>
          ...
          <!-- a simple data mapping: "body/in3:cancelPolicy/cancellationRefundInput/strServiceToken"(string) to "out3:authToken"(string) -->
          ...
          <out3:RefundCancellation>
            ...
            <!-- a simple data mapping: "body/in3:cancelPolicy/cancPolicyData/endorsementDescription"(string) to "out2:EndtDesc"(string) -->
            <xsl:if test="body/in3:cancelPolicy/cancPolicyData/endorsementDescription">
              <xsl:element name="out2:EndtDesc">
                <xsl:value-of select="body/in3:cancelPolicy/cancPolicyData/endorsementDescription"/>
              </xsl:element>
            </xsl:if>
  ...
  <xsl:template name="map:cancelPolicy_FinancialLines_InputMap_req_12">
    <xsl:param name="smo"/>
    <context>
    ...
    <body>
      ...
      <out3:webServiceRefundCancellationFinancialLines>
        ...
        <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancellationRefundInput/strServiceToken"(string) to "out3:authToken"(string) -->
        ...
        <out3:RefundCancellation>
          ...
          <!-- a simple data mapping: "$smo/body/in3:cancelPolicy/cancPolicyData/endorsementDescription"(string) to "out2:EndtDesc"(string) -->
          <xsl:if test="$smo/body/in3:cancelPolicy/cancPolicyData/endorsementDescription">
            <xsl:element name="out2:EndtDesc">
              <xsl:value-of select="$smo/body/in3:cancelPolicy/cancPolicyData/endorsementDescription"/>
            </xsl:element>
          </xsl:if>
