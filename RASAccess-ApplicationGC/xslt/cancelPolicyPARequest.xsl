...
<!-- @generated mapFile="xslt/cancelPolicyPARequest.map" md5sum="282ea334f789b59a5026742df4163a14" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		cancelPolicyPARequest.map
*   Map declaration(s):	cancelPolicyPARequest
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/correlationContext%3D%257Bhttp%253A%252F%252FAccess-ApplicationGC%257DcorrelationBO/message%3D%257BWebService_RefundCancellationPA%257DWebService_RefundCancellationPASoapIn/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:out2="WebService_RefundCancellationPA"
    xmlns:out="wsdl.WebService_RefundCancellationPA"
    xmlns:in5="http://GCLibrary/org/aig/access/bo"
    xmlns:map="http://Access-ApplicationGC/xslt/cancelPolicyPARequest"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:cancelPolicyPARequest2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:cancelPolicyPARequest"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:cancelPolicyPARequest">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out:WebService_RefundCancellationPASoapIn'"/>
        </xsl:attribute>
        <out2:WebService_RefundCancellationPA>
  ...
  <xsl:template name="map:cancelPolicyPARequest2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out:WebService_RefundCancellationPASoapIn'"/>
